...
public final class QueryUtils {
    ...
    private static List<Article> extractFeatureFromJson(String articleJSON) {
        ...
        try {
            ...
            JSONObject articleJSONObject = baseJsonResponse.getJSONObject("response");

            JSONArray articlesArray = articleJSONObject.getJSONArray("results");
            ...
            for (int i = 0; i < articlesArray.length(); i++) {
                ...
                // for that article.
                // JSONObject properties = currentArticle.getJSONObject("tags");
                ...
                Article article = new Article(sectionName, webPublicationDate, webTitle, url);
